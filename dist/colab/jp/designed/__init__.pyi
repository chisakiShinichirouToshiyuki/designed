...
class 抽象構文木クラス:
    ...
    def 検証する_関数(self, テスト: bool = False) -> 抽象構文木クラス:
        """
            数式に対して機能を適用します。
...
class 座標クラス(座標ベースクラス):
    def __init__(self, figure: 図形, ax: Any) -> None:
        ...
...
class 複合条件クラス:
    ...
    def __lshift__(self, other: SymbolCondition) -> 数学条件クラス:
        ...
...
class 命題クラス(metaclass=ABCMeta):
    ...
    @property
    def テキスト_逆命題(self) -> str:
        ...

    @property
    def テキスト_逆説(self) -> str:
        ...
...
class 不定方程式ユーティルクラス:
    ...
    def 解く_差の2乗型の不定方程式(
        ...
        セクション_ID: str = "solve_diophantine_equation_Add_and_subtract_products",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_不定方程式_d1_v2(
        ...
        セクション_ID: str = "solve_diophantine_equation_d1_v2",
    ) -> ベクトル方程式クラス:
        ...
    ...
    def 解く_分解型の不定方程式_d1_v2(
        ...
        セクション_ID: str = "solve_diophantine_equation_d1_v2_disassembly_type",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_分解型不定方程式_d2_v2(
        ...
        セクション_ID: str = "solve_diophantine_equation_d2_v2_disassembly_type",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_対称不定方程式(
        ...
        セクション_ID: str = "solve_diophantine_equation_symmetric",
    ) -> ベクトル解sクラス | None:
        """
            対称不定方程式を解く
    ...
    def 解く_急増する各辺の差の等式(
        ...
        セクション_タイトル: str = "急速に差が開く等式の解法",
        セクション_ID: str = "solve_equation_of_rapidly_increase_each_sides_difference",
    ) -> 解sクラス:
        ...
...
class 方程式クラス:
    ...
    def 取得する_不定方程式の解の範囲(
        ...
        セクションID: str = "get_solution_range_of_diophantine_equation",
    ) -> list[不等式クラス]:
        ...
    ...
    def 解く_和差の2乗型の不定方程式(
        ...
        セクションID: str = "solve_diophantine_equation_Add_and_subtract_products",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_不定方程式_d1_v2(
        ...
        セクションID: str = "solve_diophantine_equation_d1_v2",
    ) -> ベクトル方程式クラス:
        ...

    def 解く_分解型の不定方程式_d1_v2(
        self,
        セクションタイトル: str = "１次２変数の不定方程式(分解型)の解",
        セクションID: str = "solve_diophantine_equation_d1_v2_disassembly_type",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_分解型不定方程式_d2_v2(
        ...
        セクションID: str = "solve_diophantine_equation_d2_v2_disassembly_type",
    ) -> ベクトル解sクラス:
        ...
    ...
    def 解く_対称不定方程式(
        ...
        セクションID: str = "solve_diophantine_equation_symmetric",
    ) -> ベクトル解sクラス | None:
        """
            対称不定方程式を解く
    ...
    def 解く_急増する各辺の差の等式(
        self,
        スキャン範囲: tuple[int, int] = (0, 10),
        セクションタイトル: str = "急速に差が開く等式の解法",
        セクションID: str = "solve_equation_of_rapidly_increase_each_sides_difference",
    ) -> 解sクラス:
        ...
...
class 図形(図形ベースクラス):
    ...
    def 追加する_サブプロット(self, 行_列: tuple[int, int]) -> 図形:
        ...
...
class 浮動小数クラス:
    ...
    @property
    def 抽象構文木(self) -> 抽象構文木クラス.抽象構文木クラス:
        ...
    ...
    def 取得する_係数(self, フォーカス変数: str, 整数に制限するべきですか: bool = False) -> list[浮動小数クラス]:
        ...
...
class 式クラス:
    ...
    def 壊れやすい置換(self, 置換するもの: tuple[str, 式クラス]) -> 式クラス:
        ...

    def 取得する_係数(self, フォーカス変数: str, 整数を制限する必要があるかい: bool = False) -> list[式クラス]:
        ...

    def 取得する_因子(self) -> list[式クラス]:
        ...
    ...
    def 条件から識別する(
        ...
        範囲: tuple[int, int],
        セクションタイトル: str = "整数の特定",
        セクションID: str = "identify_from_condition",
    ) -> ベクトルクラス:
        ...
    ...
    def 整数粗チェック(self, 大まかな検索: bool = False, 正のみ: bool = True) -> bool | None:
        ...
    ...
    def 特定の回数(
        ...
        セクションタイトル: str = "proof_specific_times",
    ) -> bool:
        ...
    ...
    def 乗数の剰余を証明(
        ...
        モッド: int,
        セクションタイトル: str = "乗数の剰余",
        セクションID: str = "proof_powers_modularity",
    ) -> 式クラス:
        ...
...
class 分数クラス:
    ...
    def 取得する_係数(self, フォーカス変数: str, 整数を制限すべきか: bool = False) -> list[分数クラス]:
        ...
...
class 整数クラス:
    ...
    def 取得する_べき乗された残差(self, べき乗: int, mod: int, _範囲: tuple[int, int] = (1, 5)) -> 式クラス:
        ...
    ...
    def 証明する_素数が無限に存在すること(
        ...
        セクションID: str = "proof_prime_exist_indefinitely",
    ) -> 整数クラス:
        """
        素数が無限に存在することを証明します。
        """
    ...
    def 証明する_有理数の平方根が整数(
        ...
        分子: str = "q",
        分母: str = "l",
        セクションタイトル: str = "無理数の証明",
    ) -> bool:
        """
        有理数の平方根が整数であることを証明します。
        """
        ...
...
class 証明クラス:
    ...
    def 追加する_説明(
        ...
        順接符号か: bool = False,
        補遺: str = "",
        補遺の種類: Literal["because", "annotate", "plain"] = "because",
    ) -> 証明クラス:
        ...
...
class セクションクラス:
    ...
    @overload
    def 追加する(self, コンテンツ: explain, 順接符号か: bool = False) -> セクションクラス:
        ...
    ...
    def 追加する(
        ...
        順接符号か: bool = False,
        補遺: str = "",
        補遺のタイプ: Literal["because", "annotate", "plain"] = "because",
    ) -> セクションクラス:
        ...
...
class 数理的条件ユーティリティクラス:
    ...
    @staticmethod
    def 左シフト(条件_左: SymbolCondition, 条件_右: SymbolCondition) -> 数学条件クラス:
        ...
...
relation_content = Union[
    symbol_condition, Term, 数学条件クラス, 解sクラス, ベクトル方程式クラス, ベクトル解sクラス, ベクトルクラス
]
