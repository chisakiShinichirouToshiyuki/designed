...
class 複合条件クラス:
    ...
    @property
    def logical_tree(self) -> 型定義クラス.マークダウンコンテンツクラス:  # type: ignore
        pass
    ...
    @overload
    def __rshift__(self, type: type[複合条件_v1クラス]) -> 複合条件_v1クラス:  # type: ignore
        ...

    @overload
    def __rshift__(self, type: type[複合条件_v2クラス]) -> 複合条件_v2クラス:  # type: ignore
        ...
    ...
    def display_logical_tree(self) -> 複合条件クラス:  # type: ignore
        pass
    ...
    def プロットする(self, 範囲ず_プロット:  Union[型定義クラス.プロット範囲 , 型定義クラス.プロット範囲ず , 型定義クラス.プロット範囲_2次 , None] , アルファベット順: bool = True, タイトル: str = '') -> 複合条件クラス:  # type: ignore
        pass
...
class 複合条件_v1クラス(複合条件クラス):
    ...
    def __sub__(self, 式: 複合条件_v1クラス) ->  Union[複合条件_v1クラス , 型定義クラス.方程式クラス] :  # type: ignore
        pass
