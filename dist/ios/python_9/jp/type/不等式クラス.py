...
class 不等式クラス:
    def __init__(self, 証明: 型定義クラス.証明クラス, 表現形:  Union[str , express_inequation] , is_strict_mode: bool = False):
        pass
    ...
    @property
    def solved(self) ->  Union[不等式クラス , 型定義クラス.数理的真偽クラス] :  # type: ignore
        pass

    @property
    def 評価済(self) ->  Union[不等式クラス , 型定義クラス.数理的真偽クラス] :  # type: ignore
        pass
...
class 不等式_v1クラス(不等式クラス):
    ...
    def __sub__(self, 式: 不等式_v1クラス) ->  Union[型定義クラス.複合条件_v2クラス , 型定義クラス.複合条件_v1クラス , 型定義クラス.方程式クラス] :  # type: ignore
        pass
...
class 不等式_v2クラス(不等式クラス):
    ...
    def __sub__(self, 式: 不等式_v1クラス) ->  Union[型定義クラス.複合条件_v2クラス , 型定義クラス.方程式クラス] :  # type: ignore
        pass
