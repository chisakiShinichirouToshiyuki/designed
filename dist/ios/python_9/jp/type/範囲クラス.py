...
class 範囲クラス():
    ...
    def 取得できるか_整数の集合(self, 抽象木:   Union[型定義クラス.抽象木要素 , None]  = None, 走査範囲: int = 1000, エラーを出すべきか: bool = False) -> bool:  # type: ignore
        pass

    def 表示する(self):
        pass

    def 取得する_整数集合(self, 抽象木:   Union[型定義クラス.抽象木要素 , None]  = None, 走査範囲: int = 1000) -> set[int]:  # type: ignore
        pass

    def __or__(self, 式:  型定義クラス.範囲クラス) ->  Union[型定義クラス.Set , 型定義クラス.範囲クラス] :  # type: ignore
        pass

    def __and__(self, 式:  型定義クラス.範囲クラス) ->  Union[型定義クラス.Set , 型定義クラス.範囲クラス] :  # type: ignore
        pass

    def __sub__(self, 式:  型定義クラス.範囲クラス) ->  Union[型定義クラス.Set , 型定義クラス.範囲クラス] :  # type: ignore
        pass
