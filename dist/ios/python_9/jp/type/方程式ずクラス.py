...
class 方程式ずクラス:
    ...
    def __init__(self, 証明: 型定義クラス.証明クラス, 方程式ず:  Union[表現形_リスト , 表現形_タプル] ):
        pass
    ...
    def 解く(self, ターゲット_項ず: set[str] = set()) ->  Union[ベクトル方程式クラス , None] :  # type: ignore
        pass

    def 表示する(self):
        pass

    def 削除する_変数(self, ターゲット_変数: str = '', 定義式:  Union[型定義クラス.方程式クラス , None]  = None) -> 方程式ずクラス:  # type: ignore
        pass
