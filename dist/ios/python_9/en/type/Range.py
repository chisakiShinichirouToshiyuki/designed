...
class Range():
    ...
    def can_get_set_integer(self, ast:   Union[DefineType.astElement , None]  = None, set_limit: int = 1000, should_raise_error: bool = False) -> bool:  # type: ignore
        pass

    def display(self):
        pass

    def get_set_integer(self, ast:   Union[DefineType.astElement , None]  = None, set_limit: int = 1000) -> set[int]:  # type: ignore
        pass

    def __or__(self, formula:  DefineType.Range) ->  Union[DefineType.Set , DefineType.Range] :  # type: ignore
        pass

    def __and__(self, formula:  DefineType.Range) ->  Union[DefineType.Set , DefineType.Range] :  # type: ignore
        pass

    def __sub__(self, formula:  DefineType.Range) ->  Union[DefineType.Set , DefineType.Range] :  # type: ignore
        pass
