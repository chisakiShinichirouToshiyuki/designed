...
class Inequation:
    def __init__(self, proof: DefineType.Proof, express:  Union[str , express_inequation] , is_strict_mode: bool = False):
        pass
    ...
    @property
    def solved(self) ->  Union[Inequation , DefineType.SymbolicBool] :  # type: ignore
        pass

    @property
    def evaluated(self) ->  Union[Inequation , DefineType.SymbolicBool] :  # type: ignore
        pass
...
class Inequation_v1(Inequation):
    ...
    def __sub__(self, formula: Inequation_v1) ->  Union[DefineType.ComplexCondition_v2 , DefineType.ComplexCondition_v1 , DefineType.Equation] :  # type: ignore
        pass
...
class Inequation_v2(Inequation):
    ...
    def __sub__(self, formula: Inequation_v1) ->  Union[DefineType.ComplexCondition_v2 , DefineType.Equation] :  # type: ignore
        pass
