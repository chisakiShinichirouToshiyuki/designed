...
class Equation:
    def __init__(self, proof: DefineType.Proof, equation:  Union[str , term_pair] ):
        pass
    ...
    @property
    def evaluated(self) ->  Union[Equation , DefineType.SymbolicBool] :  # type: ignore
        pass
    ...
    def solve_diophantine_equation_symmetric(self, variable_size_order: list[str] = [], is_order_strict: bool = False, section_title: str = '対称式の不定方程式の解', section_id: str = 'solve_diophantine_equation_symmetric') ->  Union[DefineType.VectorSolutions , None] :  # type: ignore
        """対称不定方程式を解く
    ...
    def substitute(self, conditions:  Union[dict_float , dict_int , dict_term , Equation , DefineType.Equations] , side:  Union[literal_direction , None]  = None) -> Equation:  # type: ignore
        pass
    ...
    def get_particular_solution_d1_v2(self, search_range: tuple[int, int]) ->  Union[dict_int , None] :  # type: ignore
        pass

    def __add__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[+] の中置演算子 
    ...
    def __sub__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[-] の中置演算子 
    ...
    def __mul__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[*] の中置演算子 
    ...
    def __truediv__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[/] の中置演算子 
    ...
    def __pow__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[**] の中置演算子 
    ...
    def __radd__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[+] の中置演算子 
    ...
    def __rsub__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[-] の中置演算子 
    ...
    def __rmul__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[*] の中置演算子 
    ...
    def __rtruediv__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[/] の中置演算子 
    ...
    def __rpow__(self, equation_or_term:  Union[DefineType.Equation , DefineType.Term , int , float , DefineType.NativeFraction] ) -> DefineType.Equation:  # type: ignore
        """[**] の中置演算子 
    ...
    def __rshift__(self, type:  Union[DefineType.type_from_term_inequation , ExplainEquation , DefineEquation] ) ->  Union[DefineType.symbol_condition , ExplainEquation , DefineEquation] :  # type: ignore
        pass
...
class Equation_2d(Equation):
    def __init__(self, proof: DefineType.Proof, equation:  Union[str , term_pair] , main_variable: str = ''):
        pass
...
class ExplainEquation(Equation):
    def __init__(self, proof: DefineType.Proof, equation:  Union[str , formula_term_pair] ):
        pass
