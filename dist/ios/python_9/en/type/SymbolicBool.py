...
class SymbolicBool:
    ...
    def __eq__(self, other:  Union[bool , DefineType.symbol_condition] ) -> SymbolicBool:  # type: ignore
        pass

    def __ne__(self, other:  Union[bool , DefineType.symbol_condition] ) -> SymbolicBool:  # type: ignore
        pass

    @overload
    def __and__(self, other:  Union[bool , SymbolicBool] ) -> SymbolicBool:  # type: ignore
        ...
    ...
    def __and__(self, other:  Union[bool , SymbolicBool]  | DefineType.symbol_range) -> DefineType.symbol_condition:  # type: ignore
        pass

    @overload
    def __or__(self, other:  Union[bool , SymbolicBool] ) -> SymbolicBool:  # type: ignore
        ...
    ...
    def __or__(self, other:  Union[bool , SymbolicBool]  | DefineType.symbol_range) -> DefineType.symbol_condition:  # type: ignore
        pass
    ...
    def __rshift__(self, type:  Union[DefineType.type_from_term_inequation , DefineType.ExplainEquation , DefineType.DefineEquation] ) ->  Union[DefineType.symbol_condition , DefineType.ExplainEquation , DefineType.DefineEquation] :  # type: ignore
        pass
