...
class Proof:
    ...
    def get_variable(self, variable:  Union[str , variables_list , variables_set] ) ->  Union[DefineType.Formula , formulas] :  # type: ignore
        pass
    ...
    @overload
    def make_variable(self, variables: str, variable_types:  Union[DefineType.variable_type_optional , DefineType.variable_types_optional]  = {}) -> DefineType.Formula:  # type: ignore
        ...

    @overload
    def make_variable(self, variables: variables_list, variable_types:  Union[DefineType.variable_type_optional , DefineType.variable_types_optional]  = {}) -> formulas:  # type: ignore
        ...

    def make_variable(self, variables:  Union[str , variables_list] , variable_types:  Union[DefineType.variable_type_optional , DefineType.variable_types_optional]  = {}) ->  Union[DefineType.Formula , formulas] :  # type: ignore
        pass

    def make_variables(self, variables: str, variable_types:  Union[DefineType.variable_type_optional , DefineType.variable_types_optional]  = {}) -> formulas:  # type: ignore
        pass
    ...
    def append_explain(self,  content:  Union[DefineType.explain , DefineType.relation_content] , section: str = '', is_therefore_sign: bool = False, appendix: str = '', appendix_type: Literal['because', 'annotate', 'plain'] = 'because') -> Proof:  # type: ignore
        pass

    def insert_section(self, section:  Union[DefineType.Section , str] , parent_section:  Union[str , DefineType.Section , None]  = None) -> Proof:  # type: ignore
        pass
