...
Set = Set
Range = Range
SymbolCondition =  Union[Equation , Inequation , Unequation , ComplexCondition , SymbolicBool] 
...
single_condition =  Union[Equation , Unequation , Inequation , Inequation_v1 , Inequation_v2 , SymbolicBool] 
symbol_range =  Union[Equation , Unequation , Inequation , Inequation_v1 , Inequation_v2 , ComplexCondition , ComplexCondition_v1 , ComplexCondition_v2] 
...
explain =  Union[Section , RelationContent , str , MarkdownContents , Table , FigureReservation , VenDiagramReservation] 
...
term_ = Term |  Union[float , int]  | NativeFraction
term = Term | str |  Union[float , int]  | NativeFraction
...
relation_content =  Union[symbol_condition , Term , MathConditional , Solutions , VectorEquation , VectorSolutions , Vector] 
