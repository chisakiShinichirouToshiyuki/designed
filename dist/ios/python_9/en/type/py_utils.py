...
class Utils:
    ...
    @staticmethod
    def translate_range_to_plotRange_2d(plot_ranges:  Union[None , DefineType.plotRanges , DefineType.plotRange , DefineType.plotRange_2d] , alphabetic_axis_order: bool = True, variables: set[str] = set()) -> DefineType.plotRange_2d:  # type: ignore
        pass
