...
class ComplexCondition:
    ...
    def plot(self, plot_ranges:  Union[DefineType.plotRange , DefineType.plotRanges , DefineType.plotRange_2d , None] , alphabetic_axis_order: bool = True, title: str = '') -> ComplexCondition:  # type: ignore
        pass
...
class ComplexCondition_v1(ComplexCondition):
    ...
    def __sub__(self, formula: ComplexCondition_v1) ->  Union[ComplexCondition_v1 , DefineType.Equation] :  # type: ignore
        pass
