...
class Ast:
    ...
    def __init__(self, proof: DefineType.Proof, express: str, assertee_function: list[DefineType.symbol_type] = [], variable_types:  Union[DefineType.variable_type_optional , DefineType.variable_types_optional]  = {}):
        pass
    ...
    def get_end_leafs(self, ast:  Union[DefineType.astElement , None]  = None, leaf_type: list[DefineType.symbol_relation_type] = [], leafs: list[DefineType.astElement] = []) -> list[DefineType.astElement]:  # type: ignore
        pass

    def get_power_term(self, ast:  Union[DefineType.astElement , None]  = None) -> list[str]:  # type: ignore
        pass
