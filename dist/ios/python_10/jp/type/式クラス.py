...
class 式クラス:
    def __init__(self, 証明: 型定義クラス.証明クラス, テキスト: str | float | int, 変数タイプ: 型定義クラス.変数タイプオプション | 型定義クラス.変数タイプずオプション = {}):
        pass
    ...
    def 整数かい_ラフ版(self, rough_search: bool = False, only_positive: bool = True) -> bool | None:  # type: ignore
        pass
    ...
    def 互いに素かい(self, 相手: 型定義クラス.整数クラス | int | 式クラス, 互いに素なペア: list[tuple[int | 型定義クラス.整数クラス | 式クラス, int | 型定義クラス.整数クラス | 式クラス]] = []) -> bool | None:  # type: ignore
        pass

    def 作成する_図形(self, 範囲ず_プロット: 型定義クラス.プロット範囲 | 型定義クラス.プロット範囲ず | 型定義クラス.プロット範囲_2次 | None = None, タイトル: str = '') -> 型定義クラス.図形クラス:  # type: ignore
        pass

    def 変形する_1変数化(self, ターゲット_変数: str):
        pass

    def ラフチェックする_単調増加性(self, points: list[int] = list(range(1, 100, 20)), is_in_Natural: bool = True) -> bool | None:  # type: ignore
        pass

    def 解く(self, focus_term: str = '') -> list[式クラス]:  # type: ignore
        pass

    def 代入する(self, コンディションず: 型定義クラス.conditions_float | 型定義クラス.conditions_int | 型定義クラス.conditions_str | 型定義クラス.conditions_term | 型定義クラス.方程式クラス | 型定義クラス.方程式ずクラス) -> 式クラス:  # type: ignore
        pass

    def proof_powers_modularity(self, mod: int, 章タイトル: str = '乗数の剰余', 章ID: str = 'proof_powers_modularity'):
        pass

    def プロットする(self, 範囲ず_プロット: 型定義クラス.プロット範囲 | 型定義クラス.プロット範囲ず | 型定義クラス.プロット範囲_2次 | None = None, タイトル: str = '', color: 型定義クラス.hsla = (220, 100, 50), label: str = '') -> 式クラス:  # type: ignore
        pass
    ...
    def __add__(self, 相手:  float | int | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス | 型定義クラス.分数クラス | 式クラス) -> 式クラス:  # type: ignore
        """[+] の中置演算子 
    ...
    def __sub__(self, 相手: 式クラス | float | int | 型定義クラス.分数クラス | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[-] の中置演算子 
    ...
    def __mul__(self, 相手: 式クラス | float | int | 型定義クラス.分数クラス | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[*] の中置演算子 
    ...
    def __truediv__(self, 相手: 式クラス | float | int | 型定義クラス.分数クラス | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[/] の中置演算子 
    ...
    def __pow__(self, 相手: 式クラス | float | int | 型定義クラス.分数クラス | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[**] の中置演算子 
    ...
    def __mod__(self, 相手: 式クラス | float | int | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[%] の中置演算子 
    ...
    def __floordiv__(self, 相手: 式クラス | float | int | 型定義クラス.整数クラス | 型定義クラス.有限小数クラス) -> 式クラス:  # type: ignore
        """[//] の中置演算子 
    ...
    def __radd__(self, 相手: float | int) -> 式クラス:  # type: ignore
        """[+] の中置演算子 
    ...
    def __rsub__(self, 相手: float | int) -> 式クラス:  # type: ignore
        """[-] の中置演算子 
    ...
    def __rmul__(self, 相手: float | int) -> 式クラス:  # type: ignore
        """[*] の中置演算子 
    ...
    def __rtruediv__(self, 相手: float | int) -> 式クラス:  # type: ignore
        """[/] の中置演算子 
    ...
    def __rpow__(self, 相手: float | int) -> 式クラス:  # type: ignore
        """[**] の中置演算子 
    ...
    def __rmod__(self, 相手:  float | int) -> 式クラス:  # type: ignore
        """[%] の中置演算子 
    ...
    def __rfloordiv__(self, 相手:  float | int) -> 式クラス:  # type: ignore
        """[//] の中置演算子 
    ...
    def __eq__(self, 相手: 型定義クラス.term_ | str) -> 型定義クラス.数理的真偽クラス | 型定義クラス.方程式クラス | str:  # type: ignore
        pass
    ...
    def __ne__(self, 相手: 型定義クラス.term_ | str) -> 型定義クラス.数理的真偽クラス | 型定義クラス.非等式クラス | str:  # type: ignore
        pass
    ...
    def __rshift__(self, type: type[型定義クラス.整数クラス] | type[型定義クラス.有限小数クラス] | type[型定義クラス.分数クラス]) -> 型定義クラス.有限小数クラス | 型定義クラス.整数クラス | 型定義クラス.分数クラス:  # type: ignore
        pass
