...
class 証明クラス:
    ...
    def 取得する_変数(self, 変数: str | 変数リスト | 変数セット) -> 型定義クラス.式クラス | 式ず:  # type: ignore
        pass
    ...
    @overload
    def 作成する_変数(self, 変数ず: str, 変数タイプ: 型定義クラス.変数タイプオプション | 型定義クラス.変数タイプずオプション = {}) -> 型定義クラス.式クラス:  # type: ignore
        ...

    @overload
    def 作成する_変数(self, 変数ず: 変数リスト, 変数タイプ: 型定義クラス.変数タイプオプション | 型定義クラス.変数タイプずオプション = {}) -> 式ず:  # type: ignore
        ...

    def 作成する_変数(self, 変数ず: str | 変数リスト, 変数タイプ: 型定義クラス.変数タイプオプション | 型定義クラス.変数タイプずオプション = {}) -> 型定義クラス.式クラス | 式ず:  # type: ignore
        pass

    def 作成する_変数ず(self, 変数ず: str, 変数タイプ: 型定義クラス.変数タイプオプション | 型定義クラス.変数タイプずオプション = {}) -> 式ず:  # type: ignore
        pass
    ...
    def 追加する_説明(self,  コンテンツ: 型定義クラス.説明 | 型定義クラス.関係コンテンツ, 章: str = '', 順接かい: bool = False, 補足: str = '', 補足タイプ: Literal['because', 'annotate', 'plain'] = 'because') -> 証明クラス:  # type: ignore
        pass

    def 挿入する_章(self, 章: 型定義クラス.章クラス | str, 上位の章: str | 型定義クラス.章クラス | None = None) -> 証明クラス:  # type: ignore
        pass
