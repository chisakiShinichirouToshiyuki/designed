...
class Utils:
    @staticmethod
    def 表示する(contents: str | Markdown) -> None:  # type: ignore
        pass
    ...
    @staticmethod
    def cast(証明: 型定義クラス.証明クラス, type: 型定義クラス.term_type, テキスト: str) -> 型定義クラス.整数クラス | 型定義クラス.有限小数クラス | 型定義クラス.分数クラス | 型定義クラス.式クラス:  # type: ignore
        pass
