...
class 複合条件クラス:
    ...
    def プロットする(self, 範囲ず_プロット: 型定義クラス.プロット範囲 | 型定義クラス.プロット範囲ず | 型定義クラス.プロット範囲_2次 | None, アルファベット順: bool = True, タイトル: str = '') -> 複合条件クラス:  # type: ignore
        pass
...
class 複合条件_v1クラス(複合条件クラス):
    ...
    def __sub__(self, 式: 複合条件_v1クラス) -> 複合条件_v1クラス | 型定義クラス.方程式クラス:  # type: ignore
        pass
