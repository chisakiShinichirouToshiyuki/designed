...
class 数理的真偽クラス:
    ...
    def __eq__(self, 相手: bool | 型定義クラス.数理的コンディション) -> 数理的真偽クラス:  # type: ignore
        pass

    def __ne__(self, 相手: bool | 型定義クラス.数理的コンディション) -> 数理的真偽クラス:  # type: ignore
        pass

    @overload
    def __and__(self, 相手: bool | 数理的真偽クラス) -> 数理的真偽クラス:  # type: ignore
        ...
    ...
    def __and__(self, 相手: bool | 数理的真偽クラス | 型定義クラス.数理的範囲) -> 型定義クラス.数理的コンディション:  # type: ignore
        pass

    @overload
    def __or__(self, 相手: bool | 数理的真偽クラス) -> 数理的真偽クラス:  # type: ignore
        ...
    ...
    def __or__(self, 相手: bool | 数理的真偽クラス | 型定義クラス.数理的範囲) -> 型定義クラス.数理的コンディション:  # type: ignore
        pass
    ...
    def __rshift__(self, type: 型定義クラス.type_from_term_inequation | 型定義クラス.説明式クラス | 型定義クラス.定義式クラス) -> 型定義クラス.数理的コンディション | 型定義クラス.説明式クラス | 型定義クラス.定義式クラス:  # type: ignore
        pass
