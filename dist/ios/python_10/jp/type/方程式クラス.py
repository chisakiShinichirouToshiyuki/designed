...
class 方程式クラス:
    def __init__(self, 証明: 型定義クラス.証明クラス, 方程式: str | term_pair):
        pass
    ...
    @property
    def 評価済(self) -> 方程式クラス | 型定義クラス.数理的真偽クラス:  # type: ignore
        pass
    ...
    def 不定方程式を解く_対称型(self, 変数の大きさの順: list[str] = [], 順序の厳密性: bool = False, 章タイトル: str = '対称式の不定方程式の解', 章ID: str = '不定方程式を解く_対称型') -> 型定義クラス.ベクトル解ずクラス | None:  # type: ignore
        """対称不定方程式を解く
    ...
    def 代入する(self, コンディションず: 辞書_有限小数 | 辞書_整数 | 辞書_項 | 方程式クラス | 型定義クラス.方程式ずクラス, side: 左右 | None = None) -> 方程式クラス:  # type: ignore
        pass
    ...
    def 取得する_1次2変数の特殊解(self, 走査範囲: tuple[int, int]) -> 辞書_整数 | None:  # type: ignore
        pass

    def __add__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[+] の中置演算子 
    ...
    def __sub__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[-] の中置演算子 
    ...
    def __mul__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[*] の中置演算子 
    ...
    def __truediv__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[/] の中置演算子 
    ...
    def __pow__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[**] の中置演算子 
    ...
    def __radd__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[+] の中置演算子 
    ...
    def __rsub__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[-] の中置演算子 
    ...
    def __rmul__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[*] の中置演算子 
    ...
    def __rtruediv__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[/] の中置演算子 
    ...
    def __rpow__(self, 方程式か項: 型定義クラス.方程式クラス | 型定義クラス.項クラス | int | float | 型定義クラス.NativeFraction) -> 型定義クラス.方程式クラス:  # type: ignore
        """[**] の中置演算子 
    ...
    def __rshift__(self, type: 型定義クラス.type_from_term_inequation | 説明式クラス | 定義式クラス) -> 型定義クラス.数理的コンディション | 説明式クラス | 定義式クラス:  # type: ignore
        pass
...
class 方程式_2dクラス(方程式クラス):
    def __init__(self, 証明: 型定義クラス.証明クラス, 方程式: str | term_pair, main_variable: str = ''):
        pass
...
class 説明式クラス(方程式クラス):
    def __init__(self, 証明: 型定義クラス.証明クラス, 方程式: str | formula_term_pair):
        pass
