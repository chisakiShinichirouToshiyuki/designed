...
class Utils:
    ...
    @staticmethod
    def translate_range_to_plotRange_2d(plot_ranges: None | 型定義クラス.プロット範囲ず | 型定義クラス.プロット範囲 | 型定義クラス.プロット範囲_2次, alphabetic_axis_order: bool = True, variables: set[str] = set()) -> 型定義クラス.プロット範囲_2次:  # type: ignore
        pass
