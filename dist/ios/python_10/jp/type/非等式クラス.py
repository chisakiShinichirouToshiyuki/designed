...
class 非等式クラス:
    def __init__(self, 証明: 型定義クラス.証明クラス, 方程式: str | 表現形_項):
        pass
    ...
    @property
    def 評価済(self) -> 非等式クラス | 型定義クラス.数理的真偽クラス:  # type: ignore
        pass
    ...
    def 代入する(self, コンディションず: dict[str, float] | dict[str, int] | dict[str, 型定義クラス.項クラス] | 型定義クラス.方程式クラス | 型定義クラス.方程式ずクラス, side: Literal['left', 'right'] | None = None) -> 非等式クラス:  # type: ignore
        pass
