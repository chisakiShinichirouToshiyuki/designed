...
class Unequation:
    def __init__(self, proof: DefineType.Proof, equation: str | express_term):
        pass
    ...
    @property
    def evaluated(self) -> Unequation | DefineType.SymbolicBool:  # type: ignore
        pass
    ...
    def substitute(self, conditions: dict[str, float] | dict[str, int] | dict[str, DefineType.Term] | DefineType.Equation | DefineType.Equations, side: Literal['left', 'right'] | None = None) -> Unequation:  # type: ignore
        pass
