...
class Equations:
    ...
    def __init__(self, proof: DefineType.Proof, equations: express_list | express_tuple):
        pass
    ...
    def solve(self, focus_terms: set[str] = set()) -> VectorEquation | None:  # type: ignore
        pass

    def display(self):
        pass

    def reduce_variable(self, target_variable: str = '', define_equation: DefineType.Equation | None = None) -> Equations:  # type: ignore
        pass
