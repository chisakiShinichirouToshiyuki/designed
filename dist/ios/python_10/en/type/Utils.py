...
class Utils:
    @staticmethod
    def display(contents: str | Markdown) -> None:  # type: ignore
        pass
    ...
    @staticmethod
    def cast(proof: DefineType.Proof, type: DefineType.term_type, text: str) -> DefineType.Integer | DefineType.Float | DefineType.Fraction | DefineType.Formula:  # type: ignore
        pass
