...
default_range: DefineType.plotRange = (-10, 10)
...
class Utils:
    ...
    @staticmethod
    def translate_range_from_dict_to_tuple(plot_ranges: DefineType.plotRanges, alphabetic_axis_order: bool = True, variables: set[str] = set()) -> DefineType.plotRange_2d:  # type: ignore
        pass

    @staticmethod
    def translate_range_from_single_to_twin(plot_range: DefineType.plotRange) -> DefineType.plotRange_2d:  # type: ignore
        pass

    @staticmethod
    def translate_range_to_plotRange_2d(plot_ranges: None | DefineType.plotRanges | DefineType.plotRange | DefineType.plotRange_2d, alphabetic_axis_order: bool = True, variables: set[str] = set()) -> DefineType.plotRange_2d:  # type: ignore
        pass

    @staticmethod
    def display_safety(contents: str | Markdown | Math) -> None:  # type: ignore
        pass
