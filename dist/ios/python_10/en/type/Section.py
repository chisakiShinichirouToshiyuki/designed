...
class Section:
    ...
    def make_sub_section(self, title: str, id: str, index: int | None = None) -> Section:  # type: ignore
        pass
    ...
    def __setitem__(self, index: int, value: Section | DefineType.RelationContent) -> Section | DefineType.RelationContent:  # type: ignore
        pass
    ...
    def append(self, content: DefineType.explain | DefineType.relation_content, is_therefore_sign: bool = False, appendix: str = '', appendix_type: Literal['because', 'annotate', 'plain'] = 'because') -> Section:  # type: ignore
        pass

    def insert_section(self, section: Section | str)->Section:  # type: ignore
        pass
